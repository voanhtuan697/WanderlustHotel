...
const SuiteRoom = () => {
    return (
      ...
      {/* Tiêu đề */}
      <h2 className="text-2xl font-bold text-gray-800 mb-6">Suite Room</h2>
      <img src={images.RoomSuite} alt="Wanderlust Hotel" class="w-full h-auto" />
        ...
        <div className='w-1/2'>
          ...
          <div className="border rounded-lg p-4 mb-4">
            ...
            <p className="text-blue-600 font-bold mt-4">Price: 2.880.000 VND / night</p>
          </div>
          ...
          <div className="border rounded-lg p-4">
            ...
            <p className="text-blue-600 font-bold mt-4">Price: 3.760.000 VND / night</p>
          </div>
        </div>
        </div>
