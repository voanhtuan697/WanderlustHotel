...
const DeluxeKingDoubleRoom = () => {
    return (
      <section className="bg-gray-100 py-10 px-5 md:px-20">
      <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg">
      {/* Tiêu đề */}
      <h2 className="text-2xl font-bold text-gray-800 mb-6">Deluxe King Double Room</h2>
      <img src={images.RoomDeluxeKingdouble} alt="Wanderlust Hotel" class="w-full h-auto" />
        <div className='flex mt-9'>
        <div className="mb-8 w-1/2">
          <h3 className="text-xl font-semibold text-gray-700">Room Features</h3>
          <ul className="mt-4 space-y-2 text-gray-600">
            <li>1 king double bed</li>
            <li>45m² room</li>
            <li>Sea view</li>
            <li>City view</li>
            <li>Balcony</li>
        ...
        <div className='w-1/2'>
          ...
          <div className="border rounded-lg p-4 mb-4">
            ...
            <p className="text-blue-600 font-bold mt-4">Price: 2.550.000 VND / night</p>
          </div>
          ...
          <div className="border rounded-lg p-4">
            ...
            <p className="text-blue-600 font-bold mt-4">Price: 2.940.000 VND / night</p>
          </div>
        </div>
        </div>
...
export default DeluxeKingDoubleRoom;