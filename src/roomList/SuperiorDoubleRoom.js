...
const SuperiorDoubleRoom = () => {
    return (
    <section className="bg-gray-100 py-10 px-5 md:px-20">
      <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg">
      {/* Tiêu đề */}
      <h2 className="text-2xl font-bold text-gray-800 mb-6">Superior Double Room</h2>
      <img src={images.RoomSuperDouble} alt="Wanderlust Hotel" class="w-full h-auto" />
        ...
        <div className='w-1/2'>
          ...
          <div className="border rounded-lg p-4 mb-4">
            ...
            <p className="text-blue-600 font-bold mt-4">Price: 1.480.000 VND / night</p>
          </div>
...
export default SuperiorDoubleRoom;